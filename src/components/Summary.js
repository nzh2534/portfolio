...
function Number({n}) {
    const { number } = useSpring({
        ...
        number: n,
        delay: 200,
        config: {mass: 1, tensions: 20, friction: 10}
    });
...
<Container className="portfolio-home" style={{marginTop: "5vh"}}>
    <h4 ref={myRef}>Check out my list of </h4>
    {visible ? <Alert style={{marginTop:"10px", marginRight: "1vw", marginLeft: "1vw"}} variant='primary'><Number n={count} /></Alert> : <></>}
